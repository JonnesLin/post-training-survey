...
RehearseVLA \cite{xiao2026rehearsevla}（CVPR 2026）将 world model 从数据生成器升级为虚拟训练环境，
仅需每个任务 5 条真实示范即可显著提升性能。
VLAW \cite{guo2026vlaw} 进一步提出 VLA 策略与 world model 的迭代协同改进。
