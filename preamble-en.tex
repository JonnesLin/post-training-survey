% === Packages ===
% No ctex needed for English version
\usepackage[a4paper, left=1.3in, right=1.3in, top=1.1in, bottom=1.1in]{geometry}
...
\newcommand{\crossref}[2]{%
  {\color{\threadcolor{#1}}\(\rightarrow\) \textit{See \S\ref{#2}}}%
}
...
\newcommand{\evolution}[3]{%
  \begin{tcolorbox}[colback=green!4,colframe=green!50!black,boxrule=0.3pt,leftrule=2.5pt,left=6pt,right=4pt,top=2pt,bottom=2pt,arc=1pt]
    \small\textit{#1} \(\xrightarrow{\text{\scriptsize #3}}\) \textit{#2}
  \end{tcolorbox}
}
...
\hypersetup{
  ...
  pdftitle={LLM/VLM Post-Training: A Survey Through the Lens of Evolution},
  pdfauthor={Jinhong Lin},
  pdfsubject={LLM VLM Post-Training Survey},
  pdfkeywords={LLM, VLM, post-training, RLHF, DPO, alignment, reasoning},
}

% === Backref Formatting (bibliography -> citation page) ===
\renewcommand*{\backref}[1]{}
\renewcommand*{\backrefalt}[4]{%
  \ifcase #1 %
  \or {\small\sffamily (cited on p.\,#2)}%
  \else {\small\sffamily (cited on pp.\,#2)}%
  \fi
}
